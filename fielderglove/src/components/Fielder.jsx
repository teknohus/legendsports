        ...
        <div className="row justify-content-center text-center">
          <div className="col-lg-4 col-md-4 col-sm-6">
            <div className="hb-content bg-white ">
              ...
              <div className="image-box my-3">
                <img src={`/wp-content/reactpress/apps/fielderglove/build/images/infield.png`} className="mx-auto" alt="layer-45" />
              </div>
          ...
          <div className="col-lg-4 col-md-4 col-sm-6">
            <div className="hb-content bg-white ">
              ...
              <div className="image-box my-3">
                <img src={`/wp-content/reactpress/apps/fielderglove/build/images/outfield.png`} className="mx-auto" alt="layer-45" />
              </div>
              <div className="btn-box text-center">
