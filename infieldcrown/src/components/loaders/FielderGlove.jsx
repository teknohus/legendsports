...
export function New({rot, base, colors, personalize, personalizeConfig, xPosition, yPosition, zPosition, xRotation, yRotation, zRotation, textures }) {
  ...
  const { nodes, materials } = useGLTF("/wp-content/reactpress/apps/infieldcrown/build/Model/untitled.glb")
  ...
  const crownWelt = materials.Welting.clone();
  ...
  return (
    ...
    {base["Kip Palm Liner"] === "Kip Palm Liner (+$15)" && (
      ...
      {personalize["Index Text"] && (
        <Text
          font={fonts[personalize["Text Font"]]}
          position={personalize["Text Font"] === "Script" ? [0.00617, 0.147, 0.077] : [0.00617, 0.147, 0.077]}
          rotation={personalize["Text Font"] === "Script" ? [0*Math.PI, 0*Math.PI, -0.53125*Math.PI] : [0*Math.PI, 0*Math.PI, -0.53125*Math.PI]}
          color={personalize["Index Text Color"]}
          scale={
            personalize["Index Text Text"]?.length > 10  
              ? 0.0085 - 0.0005 * (personalize["Index Text Text"]?.length - 10)  
              : 0.0085
          }
        >
      ...
      {/*CrownPatch*/}
      {textures["Crown Color"] ? (
        <>
          <MeshWithTexture geometry={nodes.crown_patch001.geometry} material-color={colors["Crown Color"]} material={materials.Crown_Patch} rotation={[Math.PI / 2, 0, 0]} scale={0.01} texture={textures["Crown Color"]} tsize={3.5}/>
        </>
      ) : (
        <>
          <mesh geometry={nodes.crown_patch001.geometry} material-color={colors["Crown Color"]} material={materials.Crown_Patch} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
        </>
      )}
      <mesh geometry={nodes.crown_lace.geometry} material-color={colors.welt} material={crownWelt} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
      ...
      {!base.dual_welting && !base.inlay && (
        <>
          ...
          {textures.leather2 ? (
            <MeshWithTexture geometry={nodes.Index_Outer.geometry} material-color={colors.leather2} material={materials.Index_Outer} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} texture={textures.leather2} />
          ) : (
            <mesh geometry={nodes.Index_Outer.geometry} material-color={colors.leather2} material={materials.Index_Outer} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} />
          )}
          {textures.leather2 ? (
            <MeshWithTexture geometry={nodes.Middle_Inner.geometry} material-color={colors.leather2} material={materials.Middle_Inner} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} texture={textures.leather2} />
          ) : (
            <mesh geometry={nodes.Middle_Inner.geometry} material-color={colors.leather2} material={materials.Middle_Inner} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} />
          )}
          {textures.leather2 ? (
            <MeshWithTexture geometry={nodes.Middle_Outer.geometry} material-color={colors.leather2} material={materials['Middle Outer']} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} texture={textures.leather2} />
          ) : (
            <mesh geometry={nodes.Middle_Outer.geometry} material-color={colors.leather2} material={materials['Middle Outer']} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} />
          )}
          {textures.leather2 ? (
            <MeshWithTexture geometry={nodes.Ring_Inner.geometry} material-color={colors.leather2} material={materials.Ring_Inner} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} texture={textures.leather2} />
          ) : (
            <mesh geometry={nodes.Ring_Inner.geometry} material-color={colors.leather2} material={materials.Ring_Inner} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} />
          )}
          {textures.leather2 ? (
            <MeshWithTexture geometry={nodes.Ring_Outer.geometry} material-color={colors.leather2} material={materials.Ring_Outer} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} texture={textures.leather2} />
          ) : (
            <mesh geometry={nodes.Ring_Outer.geometry} material-color={colors.leather2} material={materials.Ring_Outer} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} />
          )}
          {textures.leather2 ? (
            <MeshWithTexture geometry={nodes.Pinky_Inner1.geometry} material-color={colors.leather2} material={materials.Pink_Inner} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} texture={textures.leather2} />
          ) : (
            <mesh geometry={nodes.Pinky_Inner1.geometry} material-color={colors.leather2} material={materials.Pink_Inner} position={[-0.007, 0.013, 0.009]} rotation={[1.617, -0.085, -2.45]} scale={0.008} />
          )}
        </>
      )}
        ...
        <>
          {textures.inlay ? (
           ...
           <>
            ...
            {textures.leather1 ? (
              <MeshWithTexture geometry={nodes.inlay_l2.geometry} material-color={colors.leather1} material={materials.inlay_l2} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} texture={textures.leather1} tsize={2.25} />
            ):(
              <mesh geometry={nodes.inlay_l2.geometry} material-color={colors.leather1} material={materials.inlay_l2} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
            )}
            {textures.leather2 ? (
              <MeshWithTexture geometry={nodes.inlay_l3.geometry} material-color={colors.leather2} material={materials.inlay_l3} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} texture={textures.leather2} tsize={2.25} />
            ):(
              <mesh geometry={nodes.inlay_l3.geometry} material-color={colors.leather2} material={materials.inlay_l3} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
            )}
            {textures.leather2 ? (
              <MeshWithTexture geometry={nodes.inlay_l4.geometry} material-color={colors.leather2} material={materials.inlay_l4} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} texture={textures.leather2} tsize={2.25} />
            ):(
              <mesh geometry={nodes.inlay_l4.geometry} material-color={colors.leather2} material={materials.inlay_l4} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
            )}
            {textures.leather2 ? (
              <MeshWithTexture geometry={nodes.inlay_l5.geometry} material-color={colors.leather2} material={materials.inlay_l5} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} texture={textures.leather2} tsize={2.25} />
            ):(
              <mesh geometry={nodes.inlay_l5.geometry} material-color={colors.leather2} material={materials.inlay_l5} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
            )}
            {textures.leather2 ? (
              <MeshWithTexture geometry={nodes.inlay_l6.geometry} material-color={colors.leather2} material={materials.inlay_l6} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} texture={textures.leather2} tsize={2.25} />
            ):(
              <mesh geometry={nodes.inlay_l6.geometry} material-color={colors.leather2} material={materials.inlay_l6} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
            )}
            {textures.leather2 ? (
            <MeshWithTexture geometry={nodes.inlay_l7.geometry} material-color={colors.leather2} material={materials.inlay_l7} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} texture={textures.leather2} tsize={2.25} />
            ):(
            <mesh geometry={nodes.inlay_l7.geometry} material-color={colors.leather2} material={materials.inlay_l7} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
            )}
            {textures.leather2 ? (
              <MeshWithTexture geometry={nodes.inlay_l8.geometry} material-color={colors.leather2} material={materials.inlay_l8} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} texture={textures.leather2} tsize={2.25} />
            ):(
              <mesh geometry={nodes.inlay_l8.geometry} material-color={colors.leather2} material={materials.inlay_l8} position={[0, 0.001, 0]} rotation={[Math.PI / 2, 0, 0]} scale={0.01} />
            )}
          </>
        </>
      )}
...
useGLTF.preload("/wp-content/reactpress/apps/infieldcrown/build/Model/untitled.glb")