...
export function New({rot, base, colors, personalize, personalizeConfig, xPosition, yPosition, zPosition, xRotation, yRotation, zRotation, textures }) {
  ...
  const { nodes, materials } = useGLTF("/wp-content/reactpress/apps/outfieldt5/build/Model/untitled.glb")
  ...
  return (
    ...
    {base["Kip Palm Liner"] === "Kip Palm Liner (+$15)" && (
      ...
      {/*Finger Stitch*/}
      {base["Finger Stitches"] != null && (
        <group position={[-0.061, 0.0855, -0.011]} rotation={[1.204, -0.015, 0.413]} scale={0.027}>
          <mesh geometry={nodes['1_stitch_1'].geometry} material-color={colors["Finger Stitches"]} material={materials['blinn3SG.001']} />
          <mesh geometry={nodes['1_stitch_2'].geometry} material-color={colors["Finger Stitches"]} material={materials.blinn3SG} />
        </group>  
      )}
...
useGLTF.preload("/wp-content/reactpress/apps/outfieldt5/build/Model/untitled.glb")