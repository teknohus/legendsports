...
export const meshOptions = {
  ...
  export const Options = {
    ...
    web_style: {
      textbox: false,
      options: ["Y-Web", "E-Web", "H-Web", "Laced H-Web", "T-Web","V-Web", "Laced Cross Web", "Basket Web", "Cross Web", "Net Style Web" ,"1 Piece Web", "2 Piece Web"],
      icons: null,
      colors: null,
    },
    glove_stiffness: {
