...
export function New({rot, base, colors, personalize, personalizeConfig, xPosition, yPosition, zPosition, xRotation, yRotation, zRotation, textures }) {
  ...
  const { nodes, materials } = useGLTF("/wp-content/reactpress/apps/outfieldlegend/build/Model/untitled.glb")
      ...
      {(personalize["Flag"] !== null && personalize["Flag"] !== "Other" && personalize["Flag"] !== "None") && (
        <>
          {base.finger_hood_or_pad_placement === "Index Finger" ? (
            <BackFlag nodes={nodes} materials={materials} pposition={[0.005, 0.136, 0.0662]} rotation={[Math.PI*0.256, Math.PI*0.4375, Math.PI*-0.84375]} scale={[0.03, 0.015, 0.02]} personalize={personalize} />
...
useGLTF.preload("/wp-content/reactpress/apps/outfieldlegend/build/Model/untitled.glb")