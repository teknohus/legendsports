...
export function New({rot, base, colors, personalize, personalizeConfig, xPosition, yPosition, zPosition, xRotation, yRotation, zRotation, textures }) {
  ...
  const { nodes, materials } = useGLTF("/wp-content/reactpress/apps/fielderprostar/build/Model/untitled.glb")
...
useGLTF.preload("/wp-content/reactpress/apps/fielderprostar/build/Model/untitled.glb")