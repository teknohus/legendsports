...
export function New({rot, base, colors, personalize, personalizeConfig, xPosition, yPosition, zPosition, xRotation, yRotation, zRotation, textures }) {
  const { nodes, materials } = useGLTF("/wp-content/reactpress/apps/catcherlegend/build/Model/CatcherWristFixed.glb")
  ...
  // const matPalm= materials.palm.clone();
  // const matWeb= materials.VRayMtl7.clone();
  // const matWrist = materials['leather1_2.001'].clone();
  ...
  return (
    <group dispose={null} position={[scaledXPosition, scaledYPosition, 0]} scale={scaledScale} ref={ref}>
      ...
      <group rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
        {/*Palm*/}
        {textures.palm ? (
          <MeshWithTexture geometry={nodes.Mesh036.geometry} material-color={colors.palm} material={materials.Palm} texture={textures.palm} tsize={3}/>
        ) : (
...
useGLTF.preload("/wp-content/reactpress/apps/catcherlegend/build/Model/CatcherWristFixed.glb")