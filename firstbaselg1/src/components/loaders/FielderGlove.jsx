...
export function New({rot, base, colors, personalize, personalizeConfig, xPosition, yPosition, zPosition, xRotation, yRotation, zRotation, textures }) {
  const { nodes, materials } = useGLTF("/wp-content/reactpress/apps/firstbaselg1/build/Model/untitled3-v2.glb")
...
useGLTF.preload("/wp-content/reactpress/apps/firstbaselg1/build/Model/untitled3-v2.glb")