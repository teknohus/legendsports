...
export default function Main() {
  ...
  const handleBaseChange = (option, value) => {
    ...
    if(option === 'finger_hood_or_pad' && value === 'Hood') {
      setColorSteps(prevSteps => ({
        ...prevSteps,
        "Finger Hood": true
      }));
    } else if(option === 'finger_hood_or_pad' && value !== 'Hood') {
      setColorSteps(prevSteps => ({
        ...prevSteps,
        "Finger Hood": false
      }));
    ...
    if(option === 'finger_hood_or_pad' && value === 'Pad') {
      setColorSteps(prevSteps => ({
        ...prevSteps,
        "Finger Pad": true
      }));
    } else if(option === 'finger_hood_or_pad' && value !== 'Pad') {
      setColorSteps(prevSteps => ({
        ...prevSteps,
        "Finger Pad": false
      }));
